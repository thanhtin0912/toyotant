...
(function (t) {
    ...
    function A(n, i, r) {
        ...
        return e.isMoment(u) ? (a = e.apply(null, n), Y(u, a))  : C(u) || void 0 === u ? a = e.apply(null, n)  : (s = !1, o = !1, d ? Pe.test(u) ? (u += '-01', n = [
            u
        ], s = !0, o = !0)  : (l = Ve.exec(u)) && (s = !l[5], o = !0)  : t.isArray(u) && (o = !0), a = i || s ? e.utc.apply(e, n)  : e.apply(null, n), s ? (a._ambigTime = !0, a._ambigZone = !0)  : r && (o ? a._ambigZone = !0 : d && a.zone(u))),
        a._fullCalendar = !0,
        a
    }
    function N(t, n) {
    ...
    function q(t) {
        for (var e, n = [
        ], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t); ) e[1] ? n.push(e[1])  : e[2] ? n.push({
            maybe: q(e[2])
        })  : e[3] ? n.push({
            token: e[3]
        })  : e[5] && n.push(e[5]);
    ...
    function de(t) {
        ...
        r,
        s;
        for (e = 0; t.length > e; e++) for (n = t[e], i = 0; n.length > i; i++) for (r = n[i], r.forwardSegs = [
    ...
    function me(n, r) {
        ...
        function g(n) {
            ...
            s ? (l = r.duration || s.duration, l && (l = e.duration(l), a = b(l), p = 1 === D(a, l)), p && h[a] && (r = t.extend({
            }, h[a], r)), u = c[n] || (p ? c[a] : null) || d[n] || (p ? d[a] : null) || r.buttonText || s.buttonText || (l ? o(l)  : null) || n, ge[n] = {
                'class': s,
                options: r,
                buttonText: u
            })  : void 0
                ...
                t.each(this.split(','), function (i, r) {
                    ...
                    'title' == r ? (s = s.add(t('<h2>&nbsp;</h2>')), o = !1)  : (e[r] ? l = function () {
                     ...
                     : e.isValidViewType(r) && (l = function () {
                        e.changeView(r)
                    }, p.push(r), c = e.getViewButtonText(r)), l && (a = w(n.themeButtonIcons, r), u = w(n.buttonIcons, r), d = w(n.defaultButtonText, r), h = w(n.buttonText, r), g = c || h ? z(c || h)  : a && n.theme ? '<span class=\'ui-icon ui-icon-' + a + '\'></span>' : u && !n.theme ? '<span class=\'fc-icon fc-icon-' + u + '\'></span>' : z(d || r), m = [
                        'fc-' + r + '-button',
                        f + '-button',
                        f + '-state-default'
    ...
    function ye(n) {
        ...
        function b(i, r) {
            ...
            if (n.eventDataTransform && (i = n.eventDataTransform(i)), r && r.eventDataTransform && (i = r.eventDataTransform(i)), t.extend(a, i), r && (a.source = r), a._id = i._id || (void 0 === i.id ? '_fc' + Qe++ : i.id + ''), a.className = i.className ? 'string' == typeof i.className ? i.className.split(/\s+/)  : i.className : [
            ], s = i.start || i.date, o = i.end, T(s) && (s = e.duration(s)), T(o) && (o = e.duration(o)), i.dow || e.isDuration(s) || e.isDuration(o)) a.start = s ? e.duration(s)  : null,
    ...
    _e.isSame = function (t, e) {
        var n;
        return this._fullCalendar ? e ? (n = N([this,
        t], !0), Ge.isSame.call(n[0], n[1], e))  : (t = De.moment.parseZone(t), Ge.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone))  : Ge.isSame.apply(this, arguments)
    },
    t.each(['isBefore',
    'isAfter'], function (t, e) {
        _e[e] = function (t, n) {
            var i;
            return this._fullCalendar ? (i = N([this,
            t]), Ge[e].call(i[0], i[1], n))  : Ge[e].apply(this, arguments)
        }
    }),
    ...
    var $e = Xe.extend({
        ...
        updateCellDates: function () {
            for (var t = this.view, e = this.start.clone(), n = [
            ], i = - 1, r = [
            ]; e.isBefore(this.end); ) t.isHiddenDay(e) ? r.push(i + 0.5)  : (i++, r.push(i), n.push(e.clone())),
            e.add(1, 'days');
            this.cellDates = n,
    ...
    $e.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            '<a class="' + l.join(' ') + '"' + (r.url ? ' href="' + z(r.url) + '"' : '') + (a ? ' style="' + a + '"' : '') + '>' + '<div class="fc-content">' + (this.isRTL ? n + ' ' + u : u + ' ' + n) + '</div>' + (o ? '<div class="fc-resizer"/>' : '') + '</a>'
        },
        ...
        limitRow: function (e, n) {
            ...
            if (n && S.segLevels.length > n) {
                for (s = S.segLevels[n - 1], o = S.cellMatrix, l = S.tbodyEl.children().slice(n).addClass('fc-limited').get(), a = 0; s.length > a; a++) {
                    for (u = s[a], i(u.leftCol), h = [
                    ], c = 0; u.rightCol >= D; ) r = this.getCell(e, D),
                    d = this.getCellSegs(r, n),
                    h.push(d),
                    c += d.length,
                    D++;
                    if (c) {
                        for (f = o[n - 1][u.leftCol], g = f.attr('rowspan') || 1, p = [
                        ], m = 0; h.length > m; m++) v = t('<td class="fc-more-cell"/>').attr('rowspan', g),
                        d = h[m],
                        r = this.getCell(e, u.leftCol + m),
                        w = this.renderMoreLink(r, [
                            u
                        ].concat(d)),
                        y = t('<div/>').append(w),
                        v.append(y),
    ...
    var qe = De.View = K.extend({
        ...
        computeRange: function (t) {
            var n,
            i,
            r = e.duration(this.opt('duration') || this.constructor.duration || {
                days: 1
            }),
            s = b(r),
            o = t.clone().startOf(s),
    ...
    Ce.agenda = qe.extend({
        ...
        initialize: function () {
            ...
            this.opt('allDaySlot') ? (this.dayGrid = new $e(this), this.coordMap = new Ze([this.dayGrid.coordMap,
            this.timeGrid.coordMap]))  : this.coordMap = this.timeGrid.coordMap
        },
        setRange: function (t) {
            qe.prototype.setRange.call(this, t),
