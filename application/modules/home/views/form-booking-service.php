...
<script>
    function send(){
        ...
        if(car == ''){
            notify('Vui lòng nhập mẫu xe bạn cần kiểm tra dịch vụ.', 'danger');
            return false;
        }
        if(date == ''){
            notify('Vui lòng nhập ngày mang xe kiểm tra dịch vụ.', 'danger');
            return false;
        }

        if ($('#verify-form').is(":checked") && $('#snd-verify-form').is(":checked")){
            $('#send').hide();
            $.post('<?=PATH_URL.'home/bookingService'?>',{
                car     : car,
                fullname: fullname,
                phone   : phone,
                mail   : mail,
                ...
                if(responseText[0]=='success'){
                    notify('Đặt lịch dịch vụ thành công.', 'success');
                } else {
                    notify('Đặt lịch dịch vụ không thành công.', 'danger');
                }
            }); 
        } else {
    ...
    <div class="container-fluid m2-content pt-3">
        <div class="td-crumb-container">
            ...
            <div class="entry-crumbs">
                ...
                <span itemscope="">
                    <a title="Đặt lịch dịch vụ" class="entry-crumb" itemprop="url" href="#"><span itemprop="title">Đặt lịch dịch vụ</span></a>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid m2-content connected-tech-enform-content container-test-driver">
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <img class="img-responsive" src="<?= PATH_URL ?>assets/img/bk-service.jpg" alt="">
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="test-driver-form">
                    ...
                    <div class="test-driver-group">
                        ...
                        <input class="test-driver-input" type="text" id="car" placeholder="Mẫu xe">
                    </div>
                    <div class="test-driver-group">
