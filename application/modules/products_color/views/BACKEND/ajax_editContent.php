			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Mẫu xe: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									...
									<div class="fileinput-new thumbnail" style="width: 70%">
										<img src="<?=PATH_URL.DIR_UPLOAD_CAR_COLOR.$result->avatar?>" />
									</div>
									<?php }} ?>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Mã màu:</label>
							<div class="col-md-8">
