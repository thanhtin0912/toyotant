...
function showRequest(formData, jqForm, options) {
    ...
    if(form.nameAdmincp.value == '' || form.typeAdmincp.value == '' || form.descriptionAdmincp.value == ''){
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<label class="control-label col-md-2">Trạng thái hiển thị: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
								<select class="select form-control" data-live-search="true" data-size="8" name="highlightsAdmincp" id="highlightsAdmincp">
									<option value="0">None</option>
									<option value="1" <?= isset($result->highlights) ? $result->highlights == 1 ? 'selected="selected"' : '' : '' ?>>Hiển thị màu nền đỏ</option>
									<option value="2" <?= isset($result->highlights) ? $result->highlights == 2 ? 'selected="selected"' : '' : '' ?>>Hiển thị màu xanh</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Hình ảnh(460x260): <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<?php if(isset($result->avatar)){ if($result->avatar!=''){ ?>
									<div class="fileinput-new thumbnail" style="width: 70%">
										<img src="<?=PATH_URL.DIR_UPLOAD_CATE.$result->avatar?>" />
									</div>
									<?php }} ?>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Giá bán từ:</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Mô tả khuyến mãi (nếu có):</label>
							<div class="col-md-8">
