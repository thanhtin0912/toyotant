			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Đường dẫn: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Hình ảnh(1900x955): <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Chủ đề: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Giá bán nếu có:</label>
							<div class="col-md-10"><input value="<?php if(isset($result->strvalue)) { print $result->strvalue; }else{ print '';} ?>" type="text" name="StrValueAdmincp" class="form-control"/></div>
