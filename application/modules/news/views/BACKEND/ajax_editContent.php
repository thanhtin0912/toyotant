				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<label class="control-label col-md-2">Người viết: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3"><input value="<?php if(isset($result->newsBy)) { print $result->newsBy; }else{ print '';} ?>" type="text" name="byAdmincp" id="byAdmincp" class="form-control"/></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group last">
							<label class="control-label col-md-2">Nội dung: <span class="required" aria-required="true">*</span></label>
