		...
		<table class="table table-striped table-bordered table-hover dataTable no-footer">
			<thead>
				<tr role="row">
					...
					<th class="sorting">Loại tin nhắn</th>
					<th class="sorting" onclick="sort('name')" id="name">Khách hàng</th>
					<th class="sorting" onclick="sort('mail')" id="mail">Mail</th>
					<th class="sorting" onclick="sort('phone')" id="phone">Phone</th>
					<th class="sorting">Bộ phận nhận mail</th>
			...
			<tbody>
				...
				<tr class="item_row<?=$i?> gradeX <?php ($k%2==0) ? print 'odd' : print 'even' ?>" role="row">
					...
					<td><a href="<?=PATH_URL_ADMIN.$module.'/update/'.$v->id?>"><?= $v->subject; ?></a></td>
					...
					<td><a href="<?=PATH_URL_ADMIN.$module.'/update/'.$v->id?>"><?= $v->bcc; ?></a></td>
