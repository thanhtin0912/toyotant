			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Phòng ban: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
							...
							<label class="control-label col-md-2">Chức vụ: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Tên nhân viên: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group last">
							<label class="control-label col-md-2">Sơ lượt: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group last">
							<label class="control-label col-md-2">Mô tả chi tiết: <span class="required" aria-required="true">*</span></label>
