...
<body id="home">
          ...
          <div class="footer-wrapper">
            <div class="primary-links">
              <ul class="high-level-links">
                <li class="small medium large"><a href="<?= PATH_URL; ?>lien-he">Liên hệ</a></li>
                ...
                <a title="cta-phone-roadside" href="http://online.gov.vn/Home/WebDetails/15642" target="_blank"><img class="img-responsive" width="70%" src="<?= PATH_URL; ?>assets/img/bocongthuong-dathongbao.png"></a>
              </ul>
            </div>
  ...
  <script src="<?= PATH_URL; ?>assets/js/frontend/blur-input.js"></script>
  <script type="text/javascript">
